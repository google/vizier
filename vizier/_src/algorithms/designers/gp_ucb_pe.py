  ...
  default_acquisition_optimizer_factory = vb.VectorizedOptimizerFactory(
      strategy_factory=es.VectorizedEagleStrategyFactory(
          eagle_config=es.EagleStrategyConfig(
              visibility=3.8531520841659943,
              gravity=2.9404850423149256,
              negative_gravity=0.019006238408962216,
              perturbation=0.27435618161962827,
              categorical_perturbation_factor=6.97209495578964,
              pure_categorical_perturbation_factor=26.7913174702563,
              prob_same_category_without_perturbation=0.9757052640433359,
              perturbation_lower_bound=0.0011127128824487108,
              penalize_factor=0.6922247141686396,
              pool_size_exponent=1.9066662747156424,
              mutate_normalization_type=es.MutateNormalizationType.MEAN,
              normalization_scale=2.0048423159124265,
              prior_trials_pool_pct=0.42033336568130314,
          )
      ),
